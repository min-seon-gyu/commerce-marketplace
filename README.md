...
| **성능(실측)** | N+1 제거 · 인덱스 · Redis 캐시 | 쿼리 2N→2, 인덱스 ×5.6/×8.4, 캐시로 처리량 2.4배·p95 157→73ms |
...
| **부하(k6)** | 상품 상세 캐시 적용 전/후 실측 — 처리량 772→1,856 RPS, p95 157→73ms |
...
| [`docs/05-load-test.md`](docs/05-load-test.md) | 부하테스트(k6) — 상품 상세 캐시 before/after |
